<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <body>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <form id="form1" action="/books/book_update/${requestScope.book.id}" method="post">
                        ...
                        <td class="center">
                            <input form="form1" type="date" value="${requestScope.book.dateReleaseBook}"
                                name="dateReleaseBook">
                        </td>
                        <td class="center">
